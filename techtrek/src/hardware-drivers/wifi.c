...
void wifi_uart_init(void) {
  ...
  WIFI_FifoControlReg = WIFI_FifoControlReg ^
...
// helpMessage must be in "This.format.for.it.to.work" with a maximum number of
// characters: 42
...
static int getcharWIFI(void) {
  ...
  return (
      int)WIFI_ReceiverFifo; // Read new character from ReceiverFiFo register
}
