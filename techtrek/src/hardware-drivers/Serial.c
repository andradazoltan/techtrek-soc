...
void InitRS232(void) {
  ...
  RS232_FifoControlReg = RS232_FifoControlReg ^
...
int getcharRS232(void) {
  ...
  while ((RS232_LineStatusReg & 0x1) != 0x01)
    ;
  return (
      int)RS232_ReceiverFifo; // Read new character from ReceiverFiFo register
}
