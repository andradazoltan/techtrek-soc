...
namespace Spinnaker
{
    ...
    */
    ...
    enum DEPRECATED_CLASS("This enum has been deprecated. Polarization images are now created through specific functions the ImageUtilityPolarization class.") PolarizationAlgorithm
    {
        /** No polarization. */
        NO_POLARIZATION,
    ...
    enum DEPRECATED_CLASS("This enum has been deprecated. Image scaling can now be applied through specific functions defined in the ImageUtility class.") PolarizationResolution
    {
        /** Quarter Resolution. */
        QUARTER_RESOLUTION,
        /** Full Resolution. */
    ...
    enum DEPRECATED_CLASS("This enum has been deprecated. Please use HeatmapColor in the ImageUtilityHeatmap class.") HeatMapColor
    {
        HEATMAP_BLACK = 1,
        HEATMAP_BLUE = 2,
        HEATMAP_CYAN = 3,
