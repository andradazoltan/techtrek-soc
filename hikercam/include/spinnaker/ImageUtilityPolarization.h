...
namespace Spinnaker
{
    ...
    */
    ...
    /**
    * @brief Static functions to create polarization images from image objects of pixel format Polarized8 and BayerRGPolarized8.
    */
    ...
    public:
        ...
        */
        static ImagePtr ExtractPolarQuadrant(
        ...
        */
        static ImagePtr CreateGlareReduced(
            const ImagePtr& srcImage);
        ...
        */
        static void CreateGlareReduced(
            const ImagePtr& srcImage,
