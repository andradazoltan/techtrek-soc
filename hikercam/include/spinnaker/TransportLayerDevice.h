...
public:
  ...
  /**
   * Description: User readable name of the device. If this is not defined in
   * the device this should be "VENDOR MODEL (ID)". Visibility: Expert
   */
  GenApi::IString &DeviceDisplayName;

  /**
   * Description: Gets the access status the transport layer Producer has on the
  ...
  /**
   * Description: Current gateway IP address of the GVCP interface of the remote
   * device. Visibility: Expert
   */
  GenApi::IInteger &GevDeviceGateway;

  /**
   * Description: Indicates the speed of transmission negotiated by the given
   * network interface in Mbps. Visibility: Expert
   */
  ...
  /**
   * Description: This represents the endianness of all device's registers
   * (bootstrap registers and manufacturer-specific registers). Visibility:
   * Expert
   */
  ...
  /**
   * Description: Current IP port of the GVCP interface of the selected remote
   * device. Visibility: Expert
   */
  GenApi::IInteger &GevDevicePort;

  /**
   * Description: Discovers and updates the maximum packet size that can be
   * safely used by the device on the current interface. Visibility: Expert
   */
  GenApi::ICommand &GevDeviceDiscoverMaximumPacketSize;

  /**
   * Description: The maximum packet size that can be safely used by the device
   * on the current interface. Visibility: Expert
   */
  ...
  /**
   * Description: Forces the camera to be on the same subnet as its
   * corresponding interface. Visibility: Expert
   */
  GenApi::ICommand &GevDeviceForceIP;

  /**
   * Description: Apply the force IP settings (GevDeviceForceIPAddress,
   * GevDeviceForceSubnetMask and GevDeviceForceGateway) in the Device using
   * ForceIP command. Visibility: Expert
   */
  GenApi::ICommand &GevDeviceForceIPEx;

  /**
   * Description: Static IP address to set for the GVCP interface of the remote
   * device. Visibility: Expert
   */
  GenApi::IInteger &GevDeviceForceIPAddress;

  /**
   * Description: Static subnet mask to set for GVCP interface of the remote
   * device. Visibility: Expert
   */
  GenApi::IInteger &GevDeviceForceSubnetMask;

  /**
   * Description: Static gateway IP address to set for the GVCP interface of the
   * remote device. Visibility: Expert
   */
  GenApi::IInteger &GevDeviceForceGateway;

  /**
   * Description: Controls and indicates if the device is operating in as a
   * Multicast Monitor. Visibility: Expert
   */
