...
/**
 * @brief Provides the functionality for the user to record images to an AVI
 * file.
 *
...
class DEPRECATED_CLASS("AVIRecorder is deprecated, use SpinVideo instead.")
    SPINNAKER_API AVIRecorder {
public:
  /**
   * Default constructor.
   */
