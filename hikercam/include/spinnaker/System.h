...
#define	FLIR_SPINNAKER_VERSION_BUILD 52
    ...
    */
    ...
    public:
        ...
        * @param pResultSize (Optional) The number of results in the results array. The value passed should be equal to the expected number of devices that acknowledge the command. Returns the number of received results. If this parameter is 0 or NULL, the function will return as soon as the command has been broadcasted.
