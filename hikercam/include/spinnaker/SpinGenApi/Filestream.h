    ...
    namespace GenApi
    {
        ...
        */
        ...
        public:
            ...
            ODevFileStreamBase(Spinnaker::GenApi::INodeMap * pInterface, const char * pFileName, std::ios_base::openmode mode = std::ios_base::out | std::ios_base::trunc)
                : ostream_type(std::_Noinit), m_streambuf()
            {
                this->init(&m_streambuf);
            ...
            ODevFileStreamBase(INodeMap * pInterface, const char * pFileName, std::ios_base::openmode mode = std::ios_base::out|std::ios_base::trunc)
                : ostream_type(), m_streambuf()
            {
                this->init(&m_streambuf);
                this->open(pInterface, pFileName, mode);
    ...
    #   error Unknown C++ library
        ...
        */
        ...
        public:
            ...
            IDevFileStreamBase(Spinnaker::GenApi::INodeMap * pInterface, const char * pFileName,
