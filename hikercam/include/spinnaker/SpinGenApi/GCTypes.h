...
#else
#define GC_INT64_MAX                                                           \
  static_cast<int64_t>(0x7fffffffffffffffLL) /* maximum signed int64 value */
#endif
#endif // GC_INT64_MAX
...
#else
#define GC_INT64_MIN                                                           \
  static_cast<int64_t>(0x8000000000000000LL) /* minimum signed int64 value */
#endif
#endif // GC_INT64_MIN
...
#define GC_UINT64_MAX                                                          \
  static_cast<uint64_t>(                                                       \
      0xffffffffffffffffULL) /* maximum unsigned int64 value */
#endif
#endif // GC_UINT64_MAX
...
#else
#define GC_INT32_MAX                                                           \
  static_cast<int64_t>(0x000000007fffffffLL) /* maximum signed int32 value */
#endif
#endif // GC_INT32_MAX
...
#else
#define GC_INT32_MIN                                                           \
  static_cast<int64_t>(0xffffffff80000000LL) /* minimum signed int32 value */
#endif
#endif // GC_INT32_MIN
...
#define GC_UINT32_MAX                                                          \
  static_cast<uint64_t>(                                                       \
      0x00000000ffffffffULL) /* maximum unsigned int32 value */
#endif
#endif // GC_UINT32_MAX
...
#else
#define GC_INT8_MAX                                                            \
  static_cast<int64_t>(0x000000000000007fLL) /* maximum signed int8 value */
#endif
#endif // GC_INT8_MAX
...
#else
#define GC_INT8_MIN                                                            \
  static_cast<int64_t>(0xffffffffffffff80LL) /* minimum signed int8 value */
#endif
#endif // GC_INT8_MIN
...
#else
#define GC_UINT8_MAX                                                           \
  static_cast<uint64_t>(0x00000000000000ffULL) /* maximum unsigned int8 value  \
                                                */
#endif
#endif // GC_UINT8_MAX
...
#else
#define GCBASE_API
// Classes that need RTTI info across library boundaries (like Exception
// classes) need to always use default visibility, even when symbols are being
// imported.
#define GCBASE_RTTI_CLASS_API __attribute__((visibility("default")))
#endif
#else
...
// mark a variable as unused. This prevents unused parameter/ unused local
// variable warnings on warning level 4.
#if defined(_MSC_VER)
