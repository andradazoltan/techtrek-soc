 ...
 * error
 */
SPINNAKERC_API spinNodeMapGetNode(spinNodeMapHandle hNodeMap, const char *pName,
 ...
 * @param pValue The unsigned integer pointer in which the number of nodes is
 * returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
...
SPINNAKERC_API spinNodeMapGetNodeByIndex(spinNodeMapHandle hNodeMap,
                                         size_t index, spinNodeHandle *phNode);
 ...
 * @param pbResult The boolean pointer to return whether or not the node is
 * implemented
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * @param pbResult The boolean pointer to return whether or not the two nodes
 * are equal
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
...
SPINNAKERC_API spinNodeIsEqual(spinNodeHandle hNodeFirst,
                               spinNodeHandle hNodeSecond, bool8_t *pbResult);
 ...
 * @param pBuf The c-string character buffer in which the name of the node is
 * returned
 ...
 * error
 */
SPINNAKERC_API spinNodeGetName(spinNodeHandle hNode, char *pBuf,
                               size_t *pBufLen);
 ...
 * @param pNamespace The namespace enum pointer in which the namespace is
 * returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * @param pVisibility The visibility enum pointer in which the visibility is
 * returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
...
/**
 * Invalidates a node in case its values may have changed, rendering it no
 * longer valid
 * @see spinError
 *
 ...
 * @param pCachingMode The caching mode enum pointer in which the caching mode
 * is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * @param pBuf The c-string character buffer in which the short description of
 ...
 * error
 */
SPINNAKERC_API spinNodeGetToolTip(spinNodeHandle hNode, char *pBuf,
                                  size_t *pBufLen);
 ...
 * @param pBuf The c-string character buffer in which the longer descrition of
 * the node is returned
 * @param pBufLen The unsigned integer pointer in which the length of the
 * c-string is returned; the input value is the maximum length
 *
 ...
 * error
 */
SPINNAKERC_API spinNodeGetDescription(spinNodeHandle hNode, char *pBuf,
                                      size_t *pBufLen);
 ...
 * @param pBuf The c-string character buffer in which the display name of the
 * node is returned
 * @param pBufLen The unsigned integer pointer in which the length of the
 * c-string is returned; the input value is the maximum length
 *
 ...
 * error
 */
SPINNAKERC_API spinNodeGetDisplayName(spinNodeHandle hNode, char *pBuf,
                                      size_t *pBufLen);
 ...
 * @param pCbFunction The function pointer of the function that will execute
 * when the callback is triggered; must match signature "void
 * spinNodeCallbackFunction(spinNodeHandle hNode)"
 * @param phCb The callback handle pointer in which the callback is returned;
 * used to unregister callbacks
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
 ...
 * @param imposedAccessMode The access mode enum pointer in which the imposed
 ...
 * @param imposedVisibility The visibility enum pointer in which the imposed
 * visibility is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
 ...
 * @param pBuf The c-string character buffer in which the value of the node is
 * returned
 * @param pBufLen The unsigned integer pointer in which the length of the
 * c-string is returned; the input value is the maximum length
 *
 ...
 * error
 */
SPINNAKERC_API spinNodeToString(spinNodeHandle hNode, char *pBuf,
                                size_t *pBufLen);

/**
 * Retrieves the value of any node type as a c-string; manually set whether to
 * verify the node
 * @see spinError
 *
 * @param hNode The node of the value to read
 ...
 * error
 */
SPINNAKERC_API spinNodeToStringEx(spinNodeHandle hNode, bool8_t bVerify,
                                  char *pBuf, size_t *pBufLen);

/**
 * Sets the value of any node type from a c-string; it is important to ensure
 * that the value of the c-string is appropriate to the node type
 * @see spinError
 *
...
/**
 * Sets the value of any node type from a c-string; manually set whether to
 * verify the node; ensure the value of the c-string is appropriate to the node
 * type
 * @see spinError
 *
 * @param hNode The node having its value changed
 ...
 * error
 */
SPINNAKERC_API spinNodeFromStringEx(spinNodeHandle hNode, bool8_t bVerify,
                                    const char *pBuf);
/*@}*/
 ...
 * error
 */
SPINNAKERC_API spinStringSetValueEx(spinNodeHandle hNode, bool8_t bVerify,
                                    const char *pBuf);
 ...
 * error
 */
SPINNAKERC_API spinStringGetValue(spinNodeHandle hNode, char *pBuf,
                                  size_t *pBufLen);

/**
 * Retrieves the value of a string node as a cstring; manually set whether to
 * verify the node
 * @see spinError
 *
 * @param hNode The string node of the value to read
 ...
 * error
 */
SPINNAKERC_API spinStringGetValueEx(spinNodeHandle hNode, bool8_t bVerify,
                                    char *pBuf, size_t *pBufLen);
 ...
 * @param pValue The integer pointer in which the maximum length of the c-string
 * is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * error
 */
SPINNAKERC_API spinIntegerSetValueEx(spinNodeHandle hNode, bool8_t bVerify,
                                     int64_t value);
...
/**
 * Retrieves the value of an integer node; manually set whether to verify the
 * node
 * @see spinError
 *
 * @param hNode The integer node of the value to read
 ...
 * error
 */
SPINNAKERC_API spinIntegerGetValueEx(spinNodeHandle hNode, bool8_t bVerify,
                                     int64_t *pValue);

/**
 * Retrieves the minimum value of an integer node; all potential values must be
...
/**
 * Retrieves the maximum value of an integer node; all potential values must be
 * lesser than or equal to the maximum
 * @see spinError
 *
...
/**
 * Retrieves the increment of an integer node; all possible values must be
 * divisible by the increment
 * @see spinError
 *
...
/**
 * Retrieves the numerical representation of the value of a node; i.e. linear,
 * logarithmic, hexidecimal, MAC address, etc.
 * @see spinError
 *
 * @param hNode The integer node of the numerical representation to retrieve
 * @param pValue The representation enum pointer in which the type of numerical
 ...
 * error
 */
SPINNAKERC_API spinFloatSetValueEx(spinNodeHandle hNode, bool8_t bVerify,
                                   double value);
 ...
 * error
 */
SPINNAKERC_API spinFloatGetValueEx(spinNodeHandle hNode, bool8_t bVerify,
                                   double *pValue);

/**
 * Retrieves the minimum value of a float node; all potential values must be
 * greater than or equal to the minimum
 * @see spinError
 *
...
/**
 * Retrieves the maximum value of a float node; all potential values must be
 * lesser than or equal to the maximum
 * @see spinError
 *
 ...
 * @param pBuf The c-string character buffer in which the value units are
 * returned
 * @param pBufLen The unsigned integer pointer in which the length of the
 * c-string is returned; the input value is the maximum length
 *
 ...
 * error
 */
SPINNAKERC_API spinFloatGetUnit(spinNodeHandle hNode, char *pBuf,
                                size_t *pBufLen);
/*@}*/
 ...
 * @param pValue The unsigned integer pointer in which the number of entries is
 * returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
SPINNAKERC_API spinEnumerationGetNumEntries(spinNodeHandle hNode,
                                            size_t *pValue);
 ...
 * error
 */
SPINNAKERC_API spinEnumerationGetEntryByIndex(spinNodeHandle hNode,
                                              size_t index,
 ...
 * error
 */
SPINNAKERC_API spinEnumerationGetEntryByName(spinNodeHandle hNode,
                                             const char *pName,
                                             spinNodeHandle *phEntry);
 ...
 * @param phEntry The node handle pointer in which the current entry node is
 * returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
SPINNAKERC_API spinEnumerationGetCurrentEntry(spinNodeHandle hNode,
                                              spinNodeHandle *phEntry);

/**
 * Sets a new entry using its integer value retrieved from a call to
 * spinEnumerationEntryGetIntValue(); note that enumeration entry int and enum
 * values are different - int values defined on camera, enum values found in
 * SpinnakerDefsC.h
 * @see spinEnumerationEntryGetIntValue()
 * @see spinError
 *
 * @param hNode The enum node having its entry changed
 * @param value The integer value of the entry node to set; this corresponds to
 * the integer value internal to the camera
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
...
/**
 * Sets a new entry using its enum; note that enumeration entry int and enum
 * values are different - int values defined on camera, enum values found in
 * SpinnakerDefsC.h
 ...
 * @param value The enum value of the entry node to set; this corresponds to its
 * integer value created in the library
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
...
/**
 * Retrieves the integer value of an entry node; note that enumeration entry int
 * and enum values are different - int values defined on camera, enum values
 * found in SpinnakerDefsC.h
 * @see spinEnumerationSetIntValue()
 * @see spinError
 *
 * @param hNode The entry node of the integer value to retrieve
 * @param pValue The integer pointer in which the integer value of the entry is
 * returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
...
/**
 * Retrieves the enum value (as an integer) of an entry node; note that
 * enumeraiton entry int and enum values are different - int values defined on
 * camera, enum values found in SpinnakerDefsC.h
 * @see spinEnumerationSetEnumValue()
 * @see spinError
 *
 * @param hNode The entry node of the enum value to retrieve
 * @param pValue The unsigned integer pointer in which the enum value of the
 * entry is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * @param pBuf The c-string character buffer in which the symbolic of the entry
 * node is returned
 * @param pBufLen The unsigned integer pointer in which the length of the
 * c-string is returned; the input value is the maximum length
 *
 ...
 * error
 */
SPINNAKERC_API spinEnumerationEntryGetSymbolic(spinNodeHandle hNode, char *pBuf,
                                               size_t *pBufLen);
/*@}*/
...
/**
 * Sets the value of a boolean node; boolean values are represented by 'True'
 * (which equals '0') and 'False' (which equals '1')
 * @see spinError
 *
...
/**
 * Retrieves the value of a boolean node; boolean values are represented by
 * 'True' (which equals '0') and 'False' (which equals '1')
 * @see spinError
 *
 ...
 * @param pValue The boolean pointer to return whether or not the command has
 * completed
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * @param pValue The unsigned integer pointer in which the number of features is
 * returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * @param phFeature The node handle pointer in which the feature node is
 * returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
SPINNAKERC_API spinCategoryGetFeatureByIndex(spinNodeHandle hNode, size_t index,
 ...
 * @param length The integer pointer in which the length of the register array
 * is returned; the input value is the maximum length
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
SPINNAKERC_API spinRegisterGet(spinNodeHandle hNode, uint8_t *pBuf,
                               int64_t length);

/**
 * Retrieves the value of a register node; manually set whether to verify the
 * node and whether to ignore the cache
 * @see spinError
 *
 * @param hNode The register node of the value to retrieve
 * @param bVerify The boolean of whether to verify the node
 ...
 * error
 */
SPINNAKERC_API spinRegisterGetEx(spinNodeHandle hNode, bool8_t bVerify,
                                 bool8_t bIgnoreCache, uint8_t *pBuf,
                                 int64_t length);
 ...
 * error
 */
SPINNAKERC_API spinRegisterSet(spinNodeHandle hNode, const uint8_t *pBuf,
                               int64_t length);
 ...
 * error
 */
SPINNAKERC_API spinRegisterSetEx(spinNodeHandle hNode, bool8_t bVerify,
                                 const uint8_t *pBuf, int64_t length);
 ...
 * error
 */
SPINNAKERC_API spinRegisterSetReference(spinNodeHandle hNode,
                                        spinNodeHandle hRef);
/*@}*/
