 ...
 * @see spinError
 *
 * @param phSpinVideo The spinVideo handle pointer in which the spin video
 * recorder is returned
 * @param pName The filename to save the video as; do not include the extension
 * @param option The video options related to saving as uncompressed video;
 * includes frame rate
 *
 *
 ...
 * error
 */
SPINNAKERC_API spinVideoOpenUncompressed(spinVideo *phSpinVideo,
                                         const char *pName,
 ...
 * error
 */
SPINNAKERC_API spinVideoOpenMJPG(spinVideo *phSpinVideo, const char *pName,
 ...
 * error
 */
SPINNAKERC_API spinVideoOpenH264(spinVideo *phSpinVideo, const char *pName,
 ...
 * error
 */
SPINNAKERC_API spinVideoSetMaximumFileSize(spinVideo hSpinVideo,
                                           unsigned int size);
