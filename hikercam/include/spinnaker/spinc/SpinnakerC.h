 ...
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
 ...
 * @see spinError
 *
 * @param pBuf The c-string character buffer in which the error message is
 * returned
 * @param pBufLen The unsigned integer pointer in which the length of the
 * c-string is returned; the input value is the maximum length
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
 ...
 * @see spinError
 *
 * @param pBuf The c-string character buffer in which the full error message is
 * returned
 * @param pBufLen The unsigned integer pointer in which the length of the
 * c-string is returned; the input value is the maximum length
 *
 ...
 * @see spinError
 *
 * @param pBuf The c-string character buffer in which the function name is
 * returned
 * @param pBufLen The unsigned integer pointer in which the length of the
 * c-string is returned; the input value is the maximum length
 *
 ...
 * @see spinError
 *
 * @param pBuf The c-string character buffer in which the line number is
 * returned
 * @param pBufLen The unsigned integer pointer in which the length of the
 * c-string is returned; the input value is the maximum length
 *
...
/**
 * Retrieves an instance of the system object; the system is a singleton, so
 * there will only ever be one instance; system instance must be destroyed by
 * calling spinSystemReleaseInstance
 *
 * @see spinSystemReleaseInstance
 * @see spinError
 *
 * @param phSystem The system handle pointer in which the system instance is
 * returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
...
/**
 * Releases the system; make sure handle is cleaned up properly by setting it to
 * NULL after system is released; the handle can only be used again after
 * calling spinSystemGetInstance
 *
 ...
 * @param hInterfaceList The interface list to house the interfaces from the
 * system
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * @param logLevel The logging level enum pointer in which the current logging
 * level is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
...
/**
 * Registers a logging event to the system (events registered in this way must
 * be unregistered)
 * @see spinError
 *
 ...
 * error
 */
SPINNAKERC_API spinSystemRegisterLogEvent(spinSystem hSystem,
 ...
 * error
 */
SPINNAKERC_API spinSystemUnregisterLogEvent(spinSystem hSystem,
                                            spinLogEvent hLogEvent);
 ...
 * @param pbIsInUse The boolean pointer to return whether the system is
 * currently in use
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
...
/**
 * Registers an arrival event to every interface on the system (events
 ...
 * error
 */
SPINNAKERC_API spinSystemRegisterArrivalEvent(spinSystem hSystem,
                                              spinArrivalEvent hArrivalEvent);

/**
 * Registers a removal event to the system to every interface on the system
 * (events registered this way must be unregistered)
 * @see spinError
 *
 ...
 * error
 */
SPINNAKERC_API spinSystemRegisterRemovalEvent(spinSystem hSystem,
 ...
 * error
 */
SPINNAKERC_API spinSystemUnregisterArrivalEvent(spinSystem hSystem,
                                                spinArrivalEvent hArrivalEvent);
 ...
 * error
 */
SPINNAKERC_API spinSystemUnregisterRemovalEvent(spinSystem hSystem,
                                                spinRemovalEvent hRemovalEvent);

/**
 * Registers an interface event (arrival and removal) to every interface on the
 * system (interface events registered this way must be unregistered)
 * @see spinError
 *
 * @param hSystem The system, on which the interface event is registered
 * @param hInterfaceEvent The interface event (arrival and removal) to register
 * on the system
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * @param hInterfaceEvent The interface event (arrival and removal) to
...
/**
 * Updates the list of cameras on the system, informing whether there has been
 * any changes
 * @see spinError
 *
 * @param hSystem The system, on which the list of attached cameras is updated
 * @param pbChanged The boolean pointer to return whether cameras have arrived
 * on or been removed from the system
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
...
/**
 * Updates the list of cameras on the system, informing whether there has been
 * any changes; manually set whether to update the current interface lists
 * @see spinError
 *
 * @param hSystem The system, on which the list of attached cameras is updated
 * @param bUpdateInterfaces The boolean of whether to update the interface list
 * @param pbChanged The boolean pointer to return whether cameras have arrived
 * or been removed from the system
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
 ...
 * @param iActionTime (Optional) Time when to assert a future action. Zero means
 * immediate action.
 * @param piResultSize (Optional) The number of results in the results array.
 * The value passed should be equal to the expected number of devices that
 * acknowledge the command. Returns the number of received results.
 * @param results (Optional) An Array with *piResultSize elements to hold the
 * action command result status. The buffer is filled starting from index 0. If
 * received results are less than expected number of devices that acknowledge
 * the command, remaining results are not changed. If received results are more
 * than expected number of devices that acknowledge the command, extra results
 * are ignored and not appended to array. This parameter is ignored if
 * piResultSize is 0. Thus this parameter can be NULL if pResultSize is 0 or
 * NULL.
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
...
SPINNAKERC_API spinSystemSendActionCommand(
    spinSystem hSystem, size_t iDeviceKey, size_t iGroupKey, size_t iGroupMask,
    size_t iActionTime, size_t *piResultSize, actionCommandResult results[]);

/**
 * Get current library version of Spinnaker.
 *
 * @return A struct containing the current version of Spinnaker(major, minor,
 * type, build).
 */
 ...
 *
 * @param hSystem The system handle.
 * @param phNodeMap The nodemap handle pointer in which the transport layer
 * system nodemap is returned.
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
...
/**
 * Creates an empty interface list (interface lists created this way must be
 * destroyed)
 * @see spinError
 *
 * @param phInterfaceList The interface list handle pointer in which the empty
 * interface list is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
 ...
 * @see spinError
 *
 * @param hInterfaceList The interface list where the interfaces to be counted
 * are
 * @param pSize The unsigned integer pointer in which the number of interfaces
 * is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
...
/**
 * Retrieves an interface from an interface list using an index (interfaces
 * retrieved this way must be released)
 * @see spinError
 *
 * @param hInterfaceList The interface list of the interface to be retrieved
 * @param index The index of the interface
 * @param phInterface The interface handle pointer in which the interface is
 * returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
...
SPINNAKERC_API spinInterfaceListGet(spinInterfaceList hInterfaceList,
                                    size_t index, spinInterface *phInterface);
...
/**
 * Creates an empty camera list (camera lists created this way must be
 * destroyed)
 * @see spinError
 *
 * @param phCameraList The camera list handle pointer in which the empty camera
 * list is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * @param pSize The unsigned integer pointer in which the number of cameras is
 * returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
...
/**
 * Retrieves a camera from a camera list using an index. This function will
 * return a SPINNAKER_ERR_INVALID_PARAMETER error if the input index is out of
 * range.
 * @see spinError
 *
 ...
 * error
 */
SPINNAKERC_API spinCameraListGet(spinCameraList hCameraList, size_t index,
                                 spinCamera *phCamera);
 ...
 * error
 */
SPINNAKERC_API spinCameraListAppend(spinCameraList hCameraListBase,
 ...
 * error
 */
SPINNAKERC_API spinCameraListGetBySerial(spinCameraList hCameraList,
                                         const char *pSerial,
                                         spinCamera *phCamera);
 ...
 * error
 */
SPINNAKERC_API spinCameraListRemoveBySerial(spinCameraList hCameraList,
                                            const char *pSerial);
/*@}*/
...
/**
 * Checks whether any cameras have been connected or disconnected on an
 * interface
 * @see spinError
 *
 * @param hInterface The interface of the list of attached cameras to update
 * @param pbChanged The boolean pointer to return whether or not the cameras
 * have changed
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
...
/**
 * Registers an arrival event on an interface (events registered in this way
...
/**
 * Registers a removal event on an interface (events registered in this way must
 * be unregistered)
 * @see spinError
 *
 ...
 * @param pbIsInUse The boolean pointer to return whether or not the interface
 * is in use
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 */
SPINNAKERC_API
spinInterfaceSendActionCommand(spinInterface hInterface, size_t iDeviceKey,
                               size_t iGroupKey, size_t iGroupMask,
                               size_t iActionTime, size_t *piResultSize,
 ...
 * @see spinError
 *
 * @param hCamera The camera from which the transport layer device nodemap is
 * retrieved
 * @param phNodeMap The nodemap handle pointer in which the nodemap is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 ...
 * @see spinError
 *
 * @param hCamera The camera from which the transport layer streaming nodemap is
 * retrieved
 * @param phNodeMap The nodemap handle pointer in which the nodemap is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 ...
 * @param pAccessMode The access mode enum pointer in which the access mode is
 * returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * error
 */
SPINNAKERC_API spinCameraReadPort(spinCamera hCamera, uint64_t iAddress,
                                  void *pBuffer, size_t iSize);
 ...
 * error
 */
SPINNAKERC_API spinCameraWritePort(spinCamera hCamera, uint64_t iAddress,
                                   void *pBuffer, size_t iSize);
 ...
 * @param pBuf The c-string character buffer in which the unique identifier is
 * returned
 * @param pBufLen The unsigned integer pointer in which the length of the
 * c-string is returned; the input value is the maximum length
 *
 ...
 * error
 */
SPINNAKERC_API spinCameraGetUniqueID(spinCamera hCamera, char *pBuf,
                                     size_t *pBufLen);
 ...
 * @param pbIsStreaming The boolean pointer to return whether or not the camera
 * is currently streaming
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
SPINNAKERC_API spinCameraIsStreaming(spinCamera hCamera,
 ...
 * error
 */
SPINNAKERC_API spinCameraGetGuiXml(spinCamera hCamera, char *pBuf,
                                   size_t *pBufLen);
 ...
 * error
 */
SPINNAKERC_API spinCameraRegisterDeviceEvent(spinCamera hCamera,
 ...
 * error
 */
SPINNAKERC_API spinCameraRegisterDeviceEventEx(spinCamera hCamera,
                                               spinDeviceEvent hDeviceEvent,
                                               const char *pName);
 ...
 * error
 */
SPINNAKERC_API spinCameraUnregisterDeviceEvent(spinCamera hCamera,
                                               spinDeviceEvent hDeviceEvent);
 ...
 * error
 */
SPINNAKERC_API spinCameraRegisterImageEvent(spinCamera hCamera,
 ...
 * error
 */
SPINNAKERC_API spinCameraUnregisterImageEvent(spinCamera hCamera,
                                              spinImageEvent hImageEvent);
 ...
 *
 * @param hCamera The camera to check
 * @param pbValid The boolean pointer to return whether or not the camera is
 * valid
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 *
 * @param hCamera The camera to check
 * @param pbInit The boolean pointer to return whether or not the camera is
 * initialized
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
...
/**
 * Returns the largest packet size that can be safely used on the interface that
 ...
 * error
 */
SPINNAKERC_API spinImageCreateEx(spinImage *phImage, size_t width,
                                 size_t height, size_t offsetX, size_t offsetY,
                                 spinPixelFormatEnums pixelFormat, void *pData);
...
/**
 * Sets the default color processing algorithm of all images (if not otherwise
 * set)
 * @see spinError
 *
 ...
 */
SPINNAKERC_API
spinImageSetDefaultColorProcessing(spinColorProcessingAlgorithm algorithm);

/**
 * Retrieves the default color processing algorithm
 * @see spinError
 *
 * @param pAlgorithm The color processing algorithm enum pointer in which the
 * color processing algorithm is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
SPINNAKERC_API
spinImageGetDefaultColorProcessing(spinColorProcessingAlgorithm *pAlgorithm);
 ...
 * @param pAlgorithm The color processing algorithm pointer in which the color
 * processing algorithm is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
 ...
 * @param hDestImage The image handle pointer in which the converted image is
 * returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
SPINNAKERC_API spinImageConvert(spinImage hSrcImage,
                                spinPixelFormatEnums pixelFormat,
                                spinImage hDestImage);

/**
 * Converts the pixel format and color processing algorithm of one image into a
 * new image
 * @see spinError
 *
 * @param hSrcImage The image to be converted
 ...
 * error
 */
SPINNAKERC_API spinImageConvertEx(spinImage hSrcImage,
                                  spinPixelFormatEnums pixelFormat,
 ...
 * error
 */
SPINNAKERC_API spinImageReset(spinImage hImage, size_t width, size_t height,
 ...
 * error
 */
SPINNAKERC_API spinImageResetEx(spinImage hImage, size_t width, size_t height,
                                size_t offsetX, size_t offsetY,
                                spinPixelFormatEnums pixelFormat, void *pData);
 ...
 * @param ppData The pointer to the void pointer in which the image data is
 * retrieved
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * @param ppData The pointer to the void pointer in which the private image data
 * is retrieved
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * @param pSize The unsigned integer pointer in which the size of the image data
 * if returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
...
/**
 * Creates a deep copy of an image (the destination image must be created as an
 * empty image prior to the deep copy)
 * @see spinError
 *
 * @param hSrcImage The image to be copied
 ...
 * @param pOffsetX The unsigned integer pointer in which the offset along the X
 * axis is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * @param pOffsetY The unsigned integer pointer in which the offset along the Y
 * axis is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * @param pPaddingX The unsigned integer pointer in which the padding along the
 * X axis is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * @param pPaddingY The unsigned integer pointer in which the padding along the
 * Y axis is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * @param pFrameID The unsigned integer pointer in which the frame ID is
 * returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * @param pTimeStamp The unsigned integer pointer om which the timestamp is
 * returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * @param pPayloadType The payload type enum pointer in which the payload type
 * is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
...
/**
 * Retrieves the transport layer payload type of an image (as an enum,
 * spinPayloadTypeInfoIds)
 * @see spinError
 * @see spinPayloadTypeInfoIds
 *
 * @param hImage The image of the TL payload type to retrieve
 * @param pPayloadType The payload type enum pointer in which the TL payload
 * type is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * @param pPixelFormat The pixel format enum pointer in which the pixel format
 * is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
...
/**
 * Retrieves the transport layer pixel format of an image (as an unsigned
 * integer)
 * @see spinError
 *
 * @param hImage The image of the TL pixel format to retrieve
 * @param pPixelFormat The unsigned integer pointer in which the TL pixel format
 * is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
...
/**
 * Retrieves the transport layer pixel format namespace of an image (as an enum,
 ...
 * @param pPixelFormatNamespace The pixel format namespace pointer in which the
 * pixel format namespace is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
SPINNAKERC_API spinImageGetTLPixelFormatNamespace(
    spinImage hImage, spinPixelFormatNamespaceID *pPixelFormatNamespace);
 ...
 *
 * @param hImage The image of the pixel format to retrieve
 * @param pBuf The c-string character buffer in which the pixel format symbolic
 * is returned
 * @param pBufLen The unsigned integer pointer in which the length of the
 * c-string is returned; the input value is the maximum length
 *
 ...
 * error
 */
SPINNAKERC_API spinImageGetPixelFormatName(spinImage hImage, char *pBuf,
                                           size_t *pBufLen);
 ...
 * @param pbIsIncomplete The boolean pointer to return whether or not the image
 * is incomplete
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * @param pSize The unsigned integer pointer in which the size of the valid
 * payload is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
...
/**
 * Saves an image using a specified file format (using an enum,
 * spinImageFileFormat)
 * @see spinError
 * @see spinImageFileFormat
 *
 * @param hImage The image to be saved
 * @param pFilename The filename to use to save the image (with or without the
 ...
 * error
 */
SPINNAKERC_API spinImageSave(spinImage hImage, const char *pFilename,
                             spinImageFileFormat format);

/**
 * Saves an image using a specified file format (using the extension of the
 * filename)
 * @see spinError
 *
 * @param hImage The image to be saved
 ...
 * @param pFilename The filename to use to save the image (with or without the
 * appropriate file extension)
 * @param pOption The image options related to saving as PNG; includes
 * compression level and whether to save as interlaced
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
SPINNAKERC_API spinImageSavePng(spinImage hImage, const char *pFilename,
 ...
 * @param pFilename The filename to use to save the image (with or without the
 * appropriate file extension)
 * @param pOption The image options related to saving as PPM; includes whether
 * to save as binary
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
SPINNAKERC_API spinImageSavePpm(spinImage hImage, const char *pFilename,
 ...
 * @param pFilename The filename to use to save the image (with or without the
 * appropriate file extension)
 * @param pOption The image options related to saving as PGM; includes whether
 * to save as binary
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
SPINNAKERC_API spinImageSavePgm(spinImage hImage, const char *pFilename,
 ...
 * @param pFilename The filename to use to save the image (with or without the
 * appropriate file extension)
 * @param pOption The image options related to saving as TIFF; includes
 * compression method
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
SPINNAKERC_API spinImageSaveTiff(spinImage hImage, const char *pFilename,
 ...
 * @param pFilename The filename to use to save the image (with or without the
 * appropriate file extension)
 * @param pOption The image options related to saving as JPEG; includes quality
 * and whether to save as progressive
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
SPINNAKERC_API spinImageSaveJpeg(spinImage hImage, const char *pFilename,
 ...
 * @param pFilename The filename to use to save the image (with or without the
 * appropriate file extension)
 * @param pOption The image options related to saving as JPEG 2000; includes
 * quality
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
SPINNAKERC_API spinImageSaveJpg2(spinImage hImage, const char *pFilename,
 ...
 * @param pFilename The filename to use to save the image (with or without the
 * appropriate file extension)
 * @param pOption The image options related to saving as BMP; includes whether
 * to save as indexed 8-bit
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
SPINNAKERC_API spinImageSaveBmp(spinImage hImage, const char *pFilename,
 ...
 *
 * @param hImage The image to be saved
 * @param pId The unsigned integer pointer in which the chunk layout ID is
 * returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 *
 * @param hImage The image to be saved
 * @param hStatistics The image statistics context in which the calculated
 ...
 * @param pBuf The c-string character buffer in which the explanation of image
 * status enum is returned
 * @param pBufLen The unsigned integer pointer in which the length of the
 * c-string is returned; the input value is the maximum length; if pBuf is NULL,
 * minimum length of string buffer is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
SPINNAKERC_API spinImageGetStatusDescription(spinImageStatus status, char *pBuf,
                                             size_t *pBufLen);
 ...
 *
 * @param hImage The image to be saved
 * @param pbHasCRC The boolean pointer to return whether the image has CRC
 * available
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 *
 * @param hImage The image to be saved
 * @param pBitsPerPixel The unsigned integer pointer in which the number of bits
 * per pixel is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
 ...
 *
 * @param hImage The image to be saved
 * @param pImageSize The unsigned integer pointer in which the size of the image
 * is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * @see spinError
 *
 * @param phDeviceEvent The device event handle pointer in which the device
 * event context is created
 * @param pFunction The function to be called at device event occurrences;
 * signature to match: void(*spinDeviceEventFunction)(const spinDeviceEventData
 * hEventData, const char* pEventName, void* pUserData)
 * @param pUserData Properties that can be passed into the event function
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
SPINNAKERC_API spinDeviceEventCreate(spinDeviceEvent *phDeviceEvent,
 ...
 * @see spinError
 *
 * @param phImageEvent The image event handle pointer in which the image event
 * context is created
 * @param pFunction The function to be called at image event occurrences;
 * signature to match: void(*spinImageEventFunction)(const spinImage hImage,
 * void* pUserData)
 * @param pUserData Properties that can be passed into the event function
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
SPINNAKERC_API spinImageEventCreate(spinImageEvent *phImageEvent,
 ...
 * @see spinError
 *
 * @param phArrivalEvent The arrival event handle pointer in which the arrival
 * event context is created
 * @param pFunction The function to be called at device event occurrences;
 * signature to match: void(*spinArrivalEventFunction)(void* pUserData)
 * @param pUserData Properties that can be passed into the event function
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
SPINNAKERC_API spinArrivalEventCreate(spinArrivalEvent *phArrivalEvent,
...
* @see spinError
*
* @param phRemovalEvent The removal event handle pointer in which the removal
event context is created
* @param pFunction The function to be called at device event occurrences;
signature to match: void(*spinRemovalEventFunction)(uint64_t deviceSerialNumber,
void* pUserData)
...
error
*/
SPINNAKERC_API spinRemovalEventCreate(spinRemovalEvent *phRemovalEvent,
 ...
 * @see spinError
 *
 * @param phInterfaceEvent The interface event handle pointer in which the
 * interface event context is created
 * @param pArrivalFunction The function to be called at arrival event
 * occurrences; signature to match: void(*spinArrivalEventFunction)(void*
 * pUserData)
 * @param hRemovalFunction The function to be called at removal event
 * occurrences; signature to match: void(*spinRemovalEventFunction)(uint64_t
 * deviceSerialNumber, void* pUserData)
 * @param pUserData Properties that can be passed into the event function
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * @see spinError
 *
 * @param phLogEvent The log event handle pointer in which the log event context
 * is created
 * @param pFunction The function to be called at device event occurrences;
 * signature to match: void(*spinLogEventFunction)(const spinLogEventData
 * hEventData, void* pUserData)
 * @param pUserData Properties that can be passed into the event function
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
SPINNAKERC_API spinLogEventCreate(spinLogEvent *phLogEvent,
 ...
 *
 * @param phStatistics The statistics handle pointer in which the image
 * statistics context is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
...
/**
 * Disables all channels of an image statistics context except red, blue, and
 * green
 * @see spinError
 *
...
/**
 * Disables all channels of an image statistics context except hue, saturation,
 * and lightness
 * @see spinError
 *
 ...
 * @param pbEnabled The boolean pointer to return whether or not the channel is
 * enabled
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * @param pMin The unsigned integer pointer in which the minimum value of the
 * range is returned
 * @param pMax The unsigned integer pointer in which the maximum value of the
 * range is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * @param iNumValues The unsigned integer pointer in which the number of pixel
 * values is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * @param pHistogram The pointer to the integer pointer in which the histogram
 * data is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 * @param pRangeMin The unsigned integer pointer in which the minimum value of
 * the range is returned
 * @param pRangeMax The unsigned integer pointer in which the maximum value of
 * the range is returned
 * @param pPixelValueMin The unsigned integer pointer in which the minimum pixel
 * value of the range is returned
 * @param pPixelValueMax The unsigned integer pointer in which the maximum pixel
 * value of the range is returned
 * @param pNumPixelValues The unsigned integer pointer in which the number of
 * pixel values is returned
 * @param pPixelValueMean The float pointer in which the mean pixel value is
 * returned
 * @param ppiHistogram The pointer to the pointer in which the histogram data is
 * returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
...
SPINNAKERC_API spinImageStatisticsGetAll(
    spinImageStatistics hStatistics, spinStatisticsChannel channel,
    unsigned int *pRangeMin, unsigned int *pRangeMax,
    unsigned int *pPixelValueMin, unsigned int *pPixelValueMax,
    unsigned int *pNumPixelValues, float *pPixelValueMean, int **ppHistogram);
/*@}*/
 ...
 * @param pBuf The c-string character buffer in which the category name of the
 * log event is returned
 * @param pBufLen The unsigned integer pointer in which the length of the
 * c-string is returned; the input value is the maximum length
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 ...
 *
 * @param hLogEventData The log event data received from the log event
 * @param pBuf The c-string character buffer in which the priority name of the
 * log event is returned
 * @param pBufLen The unsigned integer pointer in which the length of the
 * c-string is returned; the input value is the maximum length
 *
 ...
 *
 * @param hLogEventData The log event data received from the log event
 * @param pBuf The c-string character buffer in which the timestamp of the log
 * event is returned
 * @param pBufLen The unsigned integer pointer in which the length of the
 * c-string is returned; the input value is the maximum length
 *
 ...
 *
 * @param hLogEventData The log event data received from the log event
 * @param pBuf The c-string character buffer in which the NDC of the log event
 * is returned
 * @param pBufLen The unsigned integer pointer in which the length of the
 * c-string is returned; the input value is the maximum length
 *
 ...
 * error
 */
SPINNAKERC_API spinLogDataGetNDC(spinLogEventData hLogEventData, char *pBuf,
                                 size_t *pBufLen);
 ...
 *
 * @param hLogEventData The log event data received from the log event
 * @param pBuf The c-string character buffer in which the thread name of the log
 * event is returned
 * @param pBufLen The unsigned integer pointer in which the length of the
 * c-string is returned; the input value is the maximum length
 *
 ...
 *
 * @param hLogEventData The log event data received from the log event
 * @param pBuf The c-string character buffer in which the log message of the log
 * event is returned
 * @param pBufLen The unsigned integer pointer in which the length of the
 * c-string is returned; the input value is the maximum length
 *
 ...
 * @param pEventId The unsigned integer pointer in which the event ID is
 * returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 ...
 *
 * @param hDeviceEventData The log event data received from the log event
 * @param pBuf The unsigned integer pointer in which the event payload is
 * returned
 * @param pBufSize The unsigned integer pointer in which the size of the payload
 * is returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
...
spinDeviceEventGetPayloadData(spinDeviceEventData hDeviceEventData,
                              const uint8_t *pBuf, size_t *pBufSize);
 ...
 *
 * @param hDeviceEventData The log event data received from the log event
 * @param pBuf The c-string character buffer in which the name of the device
 * event is returned
 * @param pBufLen The unsigned integer pointer in which the length of the
 * c-string is returned; the input value is the maximum length
 *
 ...
 * files.
 *
 * NOTE: This class is deprecated and replaced by SpinVideo. Refer to
 * SpinVideoC.h instead.
 */
/*@{*/
 ...
 * @see spinError
 *
 * @param phRecorder The AVI recorder handle pointer in which the AVI recorder
 * is returned
 * @param pName The filename to save the video as; do not include the extension
 * @param option The video options related to saving as uncompressed AVI;
 * includes frame rate
 *
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
...
SPINNAKERC_API_DEPRECATED(
    "spinAVIRecorderOpenUncompressed is deprecated, use "
    "spinVideoOpenUncompressed instead.",
    spinAVIRecorderOpenUncompressed(spinAVIRecorder *phRecorder,
                                    const char *pName, spinAVIOption option));
 ...
 * is returned
 * @param pName The filename to save the video as; do not include the extension
 * @param option The video options related to saving as MJPG; includes frame
 * rate and quality
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
SPINNAKERC_API_DEPRECATED(
    "spinAVIRecorderOpenMJPG is deprecated, use spinVideoOpenMJPG instead.",
    spinAVIRecorderOpenMJPG(spinAVIRecorder *phRecorder, const char *pName,
 ...
 * @param pName The filename to save the video as; do not include the extension
 * @param option The video options related to saving as MJPG; includes frame
 * rate, bitrate, height, and width
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
SPINNAKERC_API_DEPRECATED(
    "spinAVIRecorderOpenH264 is deprecated, use spinVideoOpenH264 instead.",
    spinAVIRecorderOpenH264(spinAVIRecorder *phRecorder, const char *pName,
 ...
 */
SPINNAKERC_API_DEPRECATED(
    "spinAVIRecorderAppend is deprecated, use spinVideoAppend instead.",
    spinAVIRecorderAppend(spinAVIRecorder hRecorder, spinImage hImage));

/**
 * Set the maximum file size (in megabytes) of a AVI/MP4 file. A new AVI/MP4
 ...
 * error
 */
SPINNAKERC_API_DEPRECATED("spinAVISetMaximumSize is deprecated, use "
                          "spinVideoSetMaximumFileSize instead.",
                          spinAVISetMaximumSize(spinAVIRecorder hRecorder,
                                                unsigned int size));
 ...
 */
SPINNAKERC_API_DEPRECATED(
    "spinAVIRecorderClose is deprecated, use spinVideoClose instead.",
 ...
 * @param pValue The integer pointer in which the piece of chunk data is
 * returned
 *
 * @return spinError The error code; returns SPINNAKER_ERR_SUCCESS (or 0) for no
 * error
 */
SPINNAKERC_API spinImageChunkDataGetIntValue(spinImage hImage,
                                             const char *pName,
                                             int64_t *pValue);
 ...
 * error
 */
SPINNAKERC_API spinImageChunkDataGetFloatValue(spinImage hImage,
                                               const char *pName,
                                               double *pValue);
