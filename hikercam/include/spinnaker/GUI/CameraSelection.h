...
public:
   ...
   * CameraSelectionWindow The user needs to connect the signal to functions
   * which have parameters of   void pFunction (bool, Spinnaker::Camera*,
   * Spinnaker::Interface*);
  ...
  /**
   * Callback signal for start or stop device clicked event on listed devices in
   * CameraSelectionWidgetWindow The user needs to connect the signal to
   * functions which have parameters of void pFunction (Spinnaker::Camera*);
   * @param Spinnaker::Camera* pCamera
   */
  sigc::signal<void, Spinnaker::CameraPtr> signal_startstop_device_clicked();

  /**
   * Callback signal for configure device clicked event on listed devices in
   * CameraSelectionWidgetWindow The user needs to connect the signal to
   * functions which have parameters of void pFunction (Spinnaker::Camera*);
   * @param Spinnaker::Camera* pCamera
   */
